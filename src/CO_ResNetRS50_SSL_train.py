...
from model.CO_ResNetRS50_SSL.ResNetRS import ResNet
...
def main(args):
    ...
    train_time = 0
    # 新增：创建CSV文件并写入列标题
    with open("./data/CO_ResNetRS50_SSL/result.csv", "w") as f:
        f.write("Epoch,Number_of_Unlabeled_Images,Train_Loss,Train_Acc,Val_Loss,Val_Acc,Test_Loss,Test_Acc,Test_Pre,Test_Recall,Test_F1,Test_1_Acc,Test_2_Acc,Test_3_Acc,Test_4_Acc,Test_5_Acc,Test_7_Acc,Test_8_Acc,Test_Confusion_Matrix,Model_Parameter,Hours\n")
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if epoch < args.epochs:
                f.write(f"{epoch},{total_difference},{average_train_loss:.4f},{average_train_accuracy:.4f},{average_val_loss:.4f},{average_val_accuracy:.4f},{None},{None},{None},{None},{None},{None},{None},{None},{None},{None},{None},{None},{None},{total_params:.2f},{None}\n")
            ...
            if best_val_accuracy < average_val_accuracy:
                ...
                torch.save(state, './model/CO_ResNetRS50_SSL/' + filename + 'ckpt.t7')
        ...
        # 测试模型
        val_checkpoint = torch.load('./model/CO_ResNetRS50_SSL/Best_model_ckpt.t7')
